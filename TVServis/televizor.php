...
<?php
    ...
    $sql="select * from televizor where id=$id";
    ...
    if($_SESSION['username']!="")
    {
        if(isset($_POST['kupi']))
        {
            ...
            $stmt->bind_param("sssssds",$imeprezime,$telefon,$email,$adresa,$row['tvnaziv'],$row['cena'],$status);
...
<div class="container">
  <section>
    <h2 style="font-weight: 700">Prodaja televizora</h2>

    <br>
    <h3><?php echo $row['tvnaziv'] ?></h3>

    <div class="row">
        <div class="col-md-4">
            <img src="images/televizori/<?php echo $row['slika'] ?>" alt="<?php echo $row['tvnaziv'] ?>" width='300' height='auto'>
            <br><br>
        ...
        <div class="col-md-8">
            <?php
                if($row['opis']!="")
                {
                    ...
                    echo "<p class='opis' style='font-size:20px;'>".$opis1."</p>";
                }
                else
                {
                    echo "<p class='opis' style='font-size:20px;'>- GARANCIJA GODINU DANA <br>- BESPLATNA DOSTAVA NA KUCNU ADRESU SOPSTVENOM TERENSKOM SLUZBOM</p>";
                }
