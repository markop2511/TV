...
$sql="select * from televizor where polovan=1";
...
if(isset($_POST['pretraga']))
{
    ...
    $sql="select * from televizor where polovan=1 and tvnaziv like '%$trazi%'";
...
<div class="container">
  <section>
    <h2 style="font-weight: 700">Prodaja polovnih televizora</h2>
    <?php
